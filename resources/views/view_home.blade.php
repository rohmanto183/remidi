...
@section('isihalaman')
    ...
    <h4>Perpustakaan USM</h4>
        UPT Perpustakaan Universitas Mercu Buana Yogyakarta [UMBY] sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia 
		...
		ditempat yang cukup representative, mudah diakses baik oleh mahasiswa ataupun kalangan civitas akademika UMBY. 
		Disamping itu juga memiliki ribuan koleksi mulai dari Buku, Jurnal, Majalah, Dokumen Penelitian dan berbagai sumber 
		referensi lain guna menunjang proses pembelajaran di UMBY.
    ...
    <p>
		...
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. UPT Perpustakaan Universitas Mercu Buana Yogyakarta sampai 10 Oktober 2023 
